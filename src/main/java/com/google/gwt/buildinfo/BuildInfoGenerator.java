 ...
 * the License.
 */
package com.google.gwt.buildinfo;

import java.io.PrintWriter;

import com.google.gwt.buildinfo.client.BuildInfo;
...
public class BuildInfoGenerator extends Generator {
  ...
  private static final String REVISION_PROPERTY_NAME = "build.revision";
  ...
  private static String getBuildRevision() {
  ...
  private String emitImplClass(TreeLogger logger, GeneratorContext context, JClassType typeClass, JMethod revisionMethod, JMethod timeMethod) {
